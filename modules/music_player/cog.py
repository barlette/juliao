...
class YTDLSource(discord.PCMVolumeTransformer):
    ...
    async def create_source(cls, ctx, search: str, *, loop, download=False):
        ...
        with open('history.csv', 'a') as fp:
            fp.write(f"{data['title']},{data['webpage_url']},{ctx.author.name},{ctx.author.voice.channel},{ctx.guild}\n")
    ...
    async def player_loop(self):
        ...
        while not self.bot.is_closed():
            ...
            try:
                ...
                voice_client = discord.utils.get(self.bot.voice_clients, guild=self._guild)
                voice_client.play(discord.FFmpegPCMAudio(source='assets/exit_channel.m4a'))
                time.sleep(2)
...
class Music(commands.Cog):
    ...
    async def connect_(self, ctx, *, channel: discord.VoiceChannel=None):
        ...
        vc = ctx.voice_client
        vc.play(discord.FFmpegPCMAudio(source='assets/joined_channel.m4a'))
    ...
    async def leave_(self, ctx):
        ...
        vc.play(discord.FFmpegPCMAudio(source='assets/exit_channel.m4a'))
        time.sleep(2)
        if (random.randint(0, 1) == 0):
